...
List<RouteBase> get $appRoutes => [$searchRoute, $playerRoute];

RouteBase get $searchRoute =>
    GoRouteData.$route(path: '/', factory: $SearchRoute._fromState);
...
String _$appRouterHash() => r'eb314b9f4c0cda3ff9f12cab909d6faf4c2f0a20';
